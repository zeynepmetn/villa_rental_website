...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('realtor.locations') }}" class="btn btn-secondary">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item"><a href="{{ route('realtor.locations') }}">Lokasyonlar</a></li>
    ...
    <form action="{{ route('realtor.locations.update', $location) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card villa-card h-100">
                        ...
                        <div class="card-footer bg-transparent">
                            <a href="{{ route('realtor.villas.edit', $villa->slug) }}" class="btn btn-sm btn-primary">
