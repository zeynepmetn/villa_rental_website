                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('realtor.locations.toggle-popular', $location) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PUT')
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('realtor.locations.edit', $location) }}" 
                                    ...
                                    <form action="{{ route('realtor.locations.destroy', $location) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
...
<div class="modal fade" id="addLocationModal" tabindex="-1" role="dialog" aria-labelledby="addLocationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('realtor.locations.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('.edit-location-btn').on('click', function() {
        ...
        $.get(`/realtor/locations/${id}/data`)
            .done(function(response) {
                if (response.success) {
                    window.location.href = `/realtor/locations/${id}/edit`;
                } else {
