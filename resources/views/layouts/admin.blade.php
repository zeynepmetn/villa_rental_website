...
<head>
    ...
    <title>@yield('title', 'Yönetim Paneli') - VillaLand Admin</title>
...
<body>
    <div id="wrapper">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <a class="sidebar-brand" href="{{ route('admin.dashboard') }}">
                ...
                <div class="sidebar-brand-text">VillaLand <small>Admin</small></div>
            </a>
            ...
            <ul class="sidebar-nav">
                ...
                <!-- Villas -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.villas*') ? 'active' : '' }}" href="{{ route('admin.villas.index') }}">
    ...
    <!-- Global Notification System for Admin Dashboard -->
    <script>
    // Global notification system for admin dashboard
    console.log('Loading AdminNotification system...');
    window.AdminNotification = (function() {
        ...
        const api = {
            ...
            success: function(message, title) {
                console.log('AdminNotification.success called:', message);
                showNotification(message, 'success', title);
            },
            error: function(message, title) {
                console.log('AdminNotification.error called:', message);
                showNotification(message, 'error', title);
            }
        };
        
        console.log('AdminNotification system loaded successfully');
        return api;
    })();
    </script>
</body>
