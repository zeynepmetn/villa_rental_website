...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Yorumu Düzenle</h1>
    </div>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Yorumu Düzenle</li>
        </ol>
    </nav>
                    ...
                    <form action="{{ route('customer.reviews.update', $review) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="star-rating-input" id="starRating">
                                <input type="hidden" name="rating" id="ratingValue" value="{{ old('rating', $review->rating) }}">
                                <div class="stars">
                                    @for($i = 1; $i <= 5; $i++)
                        ...
                        <div class="alert alert-warning">
                            ...
                            <strong>Uyarı:</strong> Yorumunuzu düzenlediğinizde tekrar admin onayına gönderilecektir.
                        </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        ...
                        Mevcut Yorum Bilgileri
                    </h6>
                </div>
                <div class="card-body">
                    <p><strong>İlk Yorum Tarihi:</strong><br>{{ $review->created_at->format('d.m.Y H:i') }}</p>
                    @if($review->updated_at != $review->created_at)
                        <p><strong>Son Güncelleme:</strong><br>{{ $review->updated_at->format('d.m.Y H:i') }}</p>
                    @endif
                    <p><strong>Mevcut Puan:</strong><br>{!! $review->star_rating !!}</p>
